 ...
 */
package spring.java.jooq.generated.jooq.tables;
...
import spring.java.jooq.generated.jooq.DefaultSchema;
import spring.java.jooq.generated.jooq.Indexes;
import spring.java.jooq.generated.jooq.Keys;
...
public class Music extends TableImpl<MusicRecord> {
    ...
    private static final long serialVersionUID = -1736104658;
    ...
    /**
     * The column <code>music.id</code>. id
     */
    public final TableField<MusicRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "id");

    /**
     * The column <code>music.artist_id</code>. ã‚¢ãƒ¼ãƒ†ã‚£ã‚¹ãƒˆ ID
     */
    public final TableField<MusicRecord, Integer> ARTIST_ID = createField("artist_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "ã‚¢ãƒ¼ãƒ†ã‚£ã‚¹ãƒˆ ID");

    /**
     * The column <code>music.title</code>. title
     */
    public final TableField<MusicRecord, String> TITLE = createField("title", org.jooq.impl.SQLDataType.VARCHAR(45).nullable(false), this, "title");
    ...
    private Music(Name alias, Table<MusicRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("ãƒŸ ãƒ¥ãƒ¼ã‚·ã‚™ãƒƒã‚¯"));
    }
